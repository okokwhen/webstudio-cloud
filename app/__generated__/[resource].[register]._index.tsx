/* eslint-disable */
      ...
      import { Fragment as Fragment_1, HtmlEmbed as HtmlEmbed, Image as Image, Box as Box, Button as Button, Slot as Slot, Heading as Heading, List as List, ListItem as ListItem, Text as Text, Bold as Bold, Paragraph as Paragraph } from "@webstudio-is/sdk-components-react";
...
<Box
tag={"section"}
className={`w-box c6ekihf c1nb0s53 cu4mp27 coz4cqg c1iw9sd4 c1dtj5ge cz0oo7p ccf90o4 cxxsimo cwd459k c1njzibu`}>
<Slot>
<Fragment_1>
<HtmlEmbed
...
<Heading
className={`w-heading cwd459k c6uwl19 c1dmgvcw`}>
<Bold
...
<Text
className={`w-text c1dmgvcw`}>
<Bold
className={`w-bold-text`}>
{"Text "}
</Bold>
<RichTextLink
href={"tel:+13109221470"}
className={`w-rich-text-link cwc2kja`}>
<Bold
className={`w-bold-text c15ahqnw c9lkud8 civd7xs c1lvul23 cwc2kja`}>
{"310-922-1470"}
</Bold>
</RichTextLink>
<Bold
className={`w-bold-text`}>
{" a selfie holding a valid ID/Drivers License. The ID must be fully visible to read."}
</Bold>
</Text>
<Paragraph
className={`w-paragraph c1dmgvcw`}>
