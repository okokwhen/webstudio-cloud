/* eslint-disable */
      ...
      import { Fragment as Fragment_1, HtmlEmbed as HtmlEmbed, Image as Image, Box as Box, Button as Button, Slot as Slot, Heading as Heading, List as List, ListItem as ListItem, Text as Text, Paragraph as Paragraph, Bold as Bold } from "@webstudio-is/sdk-components-react";
import { Link as Link, RichTextLink as RichTextLink, Body as Body } from "@webstudio-is/sdk-components-react-router";
...
<Image
src={"/assets/logo-typeface_67lHwrPVVIlxeZH3Ds_mP.jpg"}
width={356}
height={67}
className={`w-image cy69cyc c1m0ktp9 cv3kzx6`} />
</Link>
<Dialog>
<DialogTrigger>
<Button
...
<DialogOverlay
className={`w-dialog-overlay cmuvpwi c1jonzyo cztv2db c12gszs3 ctaieh c1ewfgy3 civl4eh c1se0 cu4mp27 coz4cqg c1p9hr4d c1mi2d6u c15u9qwq`}>
<DialogContent
className={`w-dialog-content cv3kzx6 c1ewfgy3 cu4mp27 coz4cqg c17f72d3 c12rlhi6 c1phj05c c14xn9zz cgyr9oz c795p7h c4aslk c1ehgske c1lt5jno c78u610`}>
<Box
tag={"nav"}
role={"navigation"}
className={`w-box cu4mp27 coz4cqg c6pyjvh ca5928l`}>
<Box
className={`w-box cu4mp27 coz4cqg c1q6l818 c15gmswt`}>
<DialogTitle
className={`w-dialog-title c1sm7rqw c18dg99t cttiol5 cwc2kja cbjohj`}>
{"Minneapolis Exclusives"}
</DialogTitle>
<DialogDescription
className={`w-dialog-description clikaav c1hopcms c111vim0 cbjohj`}>
<RichTextLink
className={`w-rich-text-link cwc2kja c1i4oq45`}>
{"310-740-5237"}
</RichTextLink>
{" - Pickup Orders"}
{""}
...
{""}
<RichTextLink
className={`w-rich-text-link cwc2kja`}>
{"323-371-4088"}
</RichTextLink>
{" - Shipping & Delivery"}
</DialogDescription>
...
className={`w-box`}>
<Heading
className={`w-heading cjoyf0s cwc2kja`}>
{"Resources"}
</Heading>
<Box
className={`w-box cu4mp27 coz4cqg cbeiqzp c14rhrn`}>
<Link
href={"/resource/register"}
className={`w-link c1ttuzxs c10r8lgl cqxwjyt c18m5ny1 c87b9a`}>
<Text
className={`w-text`}>
{"Register"}
</Text>
...
<DialogClose
className={`w-close-button c1bo75lt c14mx6p cwbs124 ca5e57g cd40bcu c9i0pxj ckuwcyh cegh7e9 cu4mp27 c1dtj5ge c1iw9sd4 c1xvh1el c1htejvr c1d5yt3j cwd459k c1ert3cy cluab2z c7sfkvv c1avg2et`}>
<HtmlEmbed
...
<NavigationMenuItem
data-ws-index="0"
className={`w-menu-item ck4q36k`}>
<NavigationMenuTrigger>
<Button
className={`w-button c1d5yt3j c7fnkrg c1dtj5ge c1iw9sd4 cmthkik c1x7ee1t c1y4tju6 cq20zg9 clikaav c1hopcms c10r8lgl ctls8ky c71sr46 c18o3i2q c1qi22j9 c11yso45 cm91q73 c1jaqdov c885pcf c1efx6ce c1stjap9 c1ldecdk cy8mzru chb7a8k c1jxj627 c1mhv1rs c9phnef c14in0tx c12859n5 c1lazjhj`}>
<Text
className={`w-text`}>
{"Resources"}
</Text>
<Box
className={`w-box csbfeq7 ck8qwzt c1xvh1el c1htejvr c1g9uqnu cqi1ep8 cnzsjlt cdv2wof`}>
<HtmlEmbed
...
<Box
className={`w-box ctahyjf cu4mp27 c17f72d3 c12rlhi6 coz4cqg`}>
<NavigationMenuLink>
<Link
href={"/resource/register"}
...
<NavigationMenuTrigger>
<Button
className={`w-button c1d5yt3j c7fnkrg c1dtj5ge c1iw9sd4 cmthkik c1x7ee1t c1y4tju6 cq20zg9 clikaav c1hopcms c10r8lgl ctls8ky c71sr46 c18o3i2q c1qi22j9 c11yso45 cm91q73 c1jaqdov c885pcf c1efx6ce c1stjap9 c1ldecdk cy8mzru c1kauf7m c6rjz7g ce9ad6m cyvfrhb c16mkqgm c1lazjhj`}>
<Text
className={`w-text`}>
{"Menu"}
</Text>
...
<NavigationMenuContent
data-ws-index="1"
className={`w-menu-content c1qfxbu6 c1dj3kbp c1bo75lt c7ownnw c1r47x89 c1fi4pp7 cqhu9v6 cg0jf30 cvd2jir caqj23n cjx06tc cmx194h c10j2ty0 c1yb5xky`}>
<Box
className={`w-box cu4mp27 c17f72d3 c12rlhi6 c1po35wd ckh1f0e`}>
<Box
className={`w-box ctahyjf cu4mp27 c17f72d3 c12rlhi6 coz4cqg`}>
<NavigationMenuLink>
<Link
...
<Box
className={`w-box c1bo75lt c19lvai3 c1o8swiu cu4mp27 c1iw9sd4 c1fn72dp`}>
<NavigationMenuViewport
className={`w-menu-viewport cgyr9oz c155sw9q c11ubgxe c9l79tx cmthkik c1x7ee1t c1y4tju6 cq20zg9 c13ztwrw c1siwi8o c14xn9zz c13kzqd7 c4s2irj c18roma6 cqhu9v6 cg0jf30 cvd2jir caqj23n c15ztgnw cpxdt7x c18pmfcm c1yl2mvz`} />
</Box>
</NavigationMenu>
</Box>
</Fragment_1>
...
<Heading
className={`w-heading cwc2kja c6uwl19 c1dmgvcw`}>
{"Concentrates"}
</Heading>
</Box>
</Box>
...
<Box
className={`w-box c12sgqm7 cv3kzx6 c15u9qwq cu4mp27 c1hvieod ct5nsz8 c1kyi7gz c1ey0ix`}>
<Box
className={`w-box cu4mp27 coz4cqg c70zgtq c1ydrnuu cglawed cpphomx c1m858aa cy00zot cox8u97 czlsfng ck0b2pg c1c4tltu cmzdcgd c16orkz4 c11n7e7q cxjswcf c18wd1qf c3ha0d3 cnj9iz1 c11ubgxe c9l79tx coqbytj c1427wst cv3kzx6 c1wah0cz cwd459k c1b9gdxh c13zph20 c1cakq3q c1o342ey c1tpnlg6 c1932x9d cfl04yt`}>
<Box
className={`w-box c1phj05c cb1a3cw c1rdy5od c8h6g6d cjbr31r cu4mp27 c1dtj5ge c1iw9sd4 cmokv1g c11ubgxe c9l79tx`}>
<Image
loading={"lazy"}
src={"/assets/concentrate-live-resin_GRS1NfTsjqr9tziDnMDW4.png"}
width={960}
height={1054}
className={`w-image ckdy5dw c11kc275 cv3kzx6 c1buycge cbis4ph c1vbz5x0 cr4vlzo chpafrv chkd2zj cpx82on cc52335`} />
</Box>
<Box
className={`w-box cu4mp27 coz4cqg cnmvlfh c70zgtq c1ydrnuu cglawed c1agfrop cdoq5m0 cj7n2et`}>
<Box
className={`w-box cv3kzx6 c1dmgvcw cy50oz3 cu4mp27 coz4cqg c3o2jqk c1o6sx1 c1buycge cbis4ph c1lzowud c87b9a c176g72k`}>
<Heading
tag={"h3"}
className={`w-heading c1sm7rqw c1l2s2h8 c1hh4ju1 c1mmrcsd cwd459k`}>
{"Live Resin (Single Gram)"}
</Heading>
</Box>
<Box
className={`w-box cu4mp27 cpd4mkg c2qiv37 cv3kzx6 c1qcaze7`}>
<Box
className={`w-box cu4mp27 cpd4mkg c2qiv37 coz4cqg cv3kzx6 cm4b1t2 c2hebfb cakilxo`}>
<Heading
tag={"h3"}
className={`w-heading c1sm7rqw c1l2s2h8 c1hh4ju1 c1mmrcsd cwd459k c13t4ovc`}>
{" Prices"}
</Heading>
<Paragraph
className={`w-paragraph cdhvnet c3my65b c1ioltgo c1ctalc8`}>
{"1g - $20"}
{""}
<br />
{""}
...
<Box
className={`w-box cu4mp27 cpd4mkg c2qiv37 coz4cqg cv3kzx6 cm4b1t2 c2hebfb`}>
<Heading
tag={"h3"}
className={`w-heading c1sm7rqw c1l2s2h8 c1hh4ju1 c1mmrcsd cwd459k c13t4ovc`}>
{" Strains"}
...
<Box
className={`w-box c12sgqm7 cv3kzx6 cwd459k cu4mp27 c1hvieod ct5nsz8 c1dtj5ge cz0oo7p c70zgtq c1mn9c9p c1g9uqnu cf77yik c1vactxf c1kyi7gz`}>
<Box
className={`w-box cu4mp27 coz4cqg c70zgtq c1ydrnuu cglawed cpphomx c1m858aa cy00zot cox8u97 czlsfng ck0b2pg c1c4tltu cmzdcgd c16orkz4 c11n7e7q cxjswcf c18wd1qf c3ha0d3 cnj9iz1 c11ubgxe c9l79tx coqbytj c1427wst cv3kzx6 c1yx7rsu cwd459k c1b9gdxh c1cakq3q c1o342ey c1tpnlg6 cbqoeeo cwjflss cs9xjj3`}>
<Box
className={`w-box c1phj05c cb1a3cw c1rdy5od c8h6g6d cjbr31r cu4mp27 c1dtj5ge c1iw9sd4 cmokv1g c11ubgxe c9l79tx`}>
<Image
loading={"lazy"}
src={"/assets/concentrates-all_pVgDWi7RE9ruXNjh97uAO.jpeg"}
width={3242}
height={2278}
className={`w-image ckdy5dw c11kc275 cv3kzx6 c1buycge cbis4ph c1vbz5x0 cr4vlzo chpafrv chkd2zj cpx82on cc52335`} />
</Box>
...
<Box
className={`w-box cu4mp27 cpd4mkg c2qiv37 cv3kzx6`}>
<Box
className={`w-box cu4mp27 cpd4mkg c2qiv37 coz4cqg cv3kzx6`}>
<Heading
tag={"h3"}
className={`w-heading c1sm7rqw c1l2s2h8 c1hh4ju1 c1mmrcsd cwd459k`}>
{" "}
...
<Paragraph
className={`w-paragraph cdhvnet c3my65b c1ioltgo`}>
{"$60 a Jar"}
</Paragraph>
</Box>
<Box
...
<Fragment_1>
<Box
className={`w-box cu4mp27 coz4cqg c70zgtq c1ydrnuu cglawed cmq8p1c c1w1o0lm clncgkz cthlk3t c1w6mzta c1wz0l9g c4r6301 ct1icpw c177z1bb cbm23pr c1ynkye c1phj05c c3ha0d3 cnj9iz1 c11ubgxe c9l79tx ctfaywc cauvst7 culyw7k cnhuezd`}>
<Box
className={`w-box c1jbq3j1 c1yiv8kw c1u1p9vu cik7r9g czynrs c18aaiwz`}>
<Box
className={`w-box ck4q36k coz4cqg cxxsimo ccf90o4 c16a0lg0`}>
<Slot>
<Fragment_1>
<Link
aria-label={"Home"}
...
<Box
className={`w-box cu4mp27 c1adzsxc c1yiv8kw c1j8riap cthfscy c14ibyr1`}>
<Box
tag={"nav"}
aria-labelledby={"menu2Title"}
className={`w-box cu4mp27 c1ydrnuu cglawed coz4cqg c1g9uqnu c168qb8z`}>
<Heading
tag={"h2"}
id={"menu2Title"}
className={`w-heading c18l2wjt c1l2s2h8 c1hh4ju1 c1mmrcsd c111vim0`}>
{"Resources"}
</Heading>
<List
className={`w-list clipwj3 c93v38s ch95qu3 cu4mp27 cxxsimo ccf90o4 coz4cqg`}>
<ListItem
className={`w-list-item`}>
<Link
href={"/resource/register"}
className={`w-link cwd459k c7fnkrg cpz6ong cex7749 c1zvpxi coe7u2v cebowtb c11yso45 c1b9jjvs c1ey6spw c1dtj5ge c1iw9sd4 c1d5yt3j ccqflnv c4f7xok csfqdt0 c18di848 c87b9a c1rqq3e2 cu93cby c30dx2a c93v38s c1ittiww cai9lco c1lazjhj c1oll5bh`}>
{"Register"}
</Link>
</ListItem>
<ListItem
