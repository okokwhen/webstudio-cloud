...
<Heading
className={`w-heading cwc2kja c1kgov5b c1dmgvcw`}>
...
<Paragraph
className={`w-paragraph c1dmgvcw cwc2kja`}>
...
<Paragraph
className={`w-paragraph csl537a c1sm7rqw ciifnqf`}>
<Bold
className={`w-bold-text`}>
{"Delivery"}
</Bold>
...
<br />
{""}
{"• The cut off time to order for a delivery is 3pm (deliveries start after and we do not carry extras)."}
{""}
<br />
{""}
{"• Have your cash in your hands before messaging an order (this makes everything go much smoother)."}
{""}
<br />
{""}
{"• $40 minimum for a delivery."}
{""}
<br />
{""}
{""}
...
<br />
{""}
{"• $5.00 Parking Lot Fee (Credit/Debit Card)."}
{""}
<br />
{""}
...
<br />
{""}
{"• Discreet Shipping anywhere in the USA."}
{""}
<br />
{""}
{"• There is a Shipping charge, price will vary based off of Shipping method."}
{""}
<br />
{""}
{"• Bitcoin is the only payment option for Shipping."}
</Paragraph>
</Box>
</Box>
<Slot>
