...
<Image
loading={"lazy"}
src={"/assets/pen-resin-cartridge_qAFgEjosXkhpcoSbbHz88.png"}
width={960}
height={1054}
...
{"Live Resin 1g Cartridge"}
</Heading>
<Collapsible
className={`w-collapsible`}>
<CollapsibleTrigger>
<Button
className={`w-button c1d5yt3j cwc2kja ccqflnv c4f7xok csfqdt0 c18di848 c12859n5`}>
{"Show Description"}
</Button>
</CollapsibleTrigger>
<CollapsibleContent
...
<Text
className={`w-text`}>
{"These are not normal carts. We use a blend of 65% melted down THCA Diamonds with a 25% mixture of High Terpene Extract(HTE) which is essentially the sauce from our live resin concentrates and 10% Cannabis Derived Terpenes(CDT) which is refined HTE. You will experience a full spectrum, natural flavor and high. Small batch and hand filled for quality control."}
</Text>
</CollapsibleContent>
</Collapsible>
</Box>
...
<Image
loading={"lazy"}
src={"/assets/pen-rosin-vaporizer_vlON1d_BYwIfrNW4GgeJq.png"}
width={960}
height={1054}
className={`w-image ckdy5dw c11kc275 cv3kzx6 c1buycge cbis4ph c1vbz5x0 cr4vlzo chpafrv chkd2zj cpx82on cc52335`} />
</Box>
